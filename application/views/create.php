...
<body>
    ...
    <div class="container mt-5">
        <h2 style="margin-top:10px;">Create User</h2>
            ...
            <div class="row ">
                <div class="col-md-6 border">
                    <div class="form-group mt-3">
                        ...
                        <input type="text" name="uname" id="uname" value="<?php echo set_value('uname'); ?>" placeholder="Enter Username" class="form-control">
                        <?php echo form_error('uname'); ?>
                    </div>
                    <div class="form-group mt-3">
                        <label for="email" class="form-control-label"><b>Email :</b></label>
                        <input type="text" name="email" id="email" value="<?php echo set_value('email'); ?>" placeholder="Enter Email" class="form-control">
                        <?php echo form_error('email'); ?>
                    </div>
                    <div>
                        <button class="btn btn-outline-primary my-3 mr-2">Create</button>
